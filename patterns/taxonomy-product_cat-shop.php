<?php
/**
 * Title: taxonomy-product_cat-shop
 * Slug: theme-rmpro/taxonomy-product_cat-shop
 * Description : Template pour afficher la catégorie shop
 * Inserter: no
 */
?>
<!-- wp:template-part {"slug":"header"} /-->

<!-- wp:group {"metadata":{"name":"Main"},"style":{"spacing":{"padding":{"top":"0","bottom":"0","left":"0","right":"0"},"margin":{"top":"0","bottom":"0"},"blockGap":"0"}},"layout":{"type":"default"}} -->
<div class="wp-block-group" style="margin-top:0;margin-bottom:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/image-medium-3webp-scaled.webp","dimRatio":60,"overlayColor":"contrast-2","isUserOverlayColor":true,"focalPoint":{"x":0.52000000000000002,"y":0.65000000000000002},"className":"is-style-ng1-banner-bw","style":{"spacing":{"margin":{"bottom":"1rem"}}},"fontSize":"small","layout":{"type":"constrained"}} -->
<div class="wp-block-cover is-style-ng1-banner-bw has-small-font-size" style="margin-bottom:1rem"><span aria-hidden="true" class="wp-block-cover__background has-contrast-2-background-color has-background-dim-60 has-background-dim"></span><img class="wp-block-cover__image-background " alt="" src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/image-medium-3webp-scaled.webp" style="object-position:52% 65%" data-object-fit="cover" data-object-position="52% 65%"/><div class="wp-block-cover__inner-container"><!-- wp:group {"align":"wide","style":{"dimensions":{"minHeight":"318px"},"spacing":{"padding":{"right":"var:preset|spacing|2","left":"var:preset|spacing|2"}}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"left"}} -->
...
<!-- wp:group {"style":{"spacing":{"margin":{"bottom":"1rem"}}},"fontSize":"small","layout":{"type":"constrained","contentSize":"1240px"}} -->
<div class="wp-block-group has-small-font-size" style="margin-bottom:1rem"><!-- wp:group {"style":{"spacing":{"margin":{"bottom":"1rem"},"padding":{"right":"var:preset|spacing|2","left":"var:preset|spacing|2"}}},"fontSize":"small","layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"center","verticalAlignment":"top"}} -->
<div class="wp-block-group has-small-font-size" style="margin-bottom:1rem;padding-right:var(--wp--preset--spacing--2);padding-left:var(--wp--preset--spacing--2)"><!-- wp:group {"className":"show-only-on-desktop","style":{"spacing":{"margin":{"bottom":"1rem"}}},"fontSize":"small","layout":{"type":"constrained"}} -->
<div id="cat-menu" class="wp-block-group show-only-on-desktop has-small-font-size" style="margin-bottom:1rem"><!-- wp:group {"className":"hide-on-tablet-desktop","layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"right"}} -->
...
<main class="wp-block-group has-small-font-size" style="margin-bottom:1rem"><!-- wp:woocommerce/store-notices /-->
...
<!-- wp:post-title {"textAlign":"center","level":3,"isLink":true,"style":{"elements":{"link":{"color":{"text":"var:preset|color|contrast-2"}}}},"fontSize":"m","__woocommerceNamespace":"woocommerce/product-collection/product-title"} /-->
